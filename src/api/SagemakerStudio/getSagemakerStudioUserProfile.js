...
const getSagemakerStudioUserProfile = (sagemakerStudioUserProfileUri)=>{
    return {
        ...
        query:gql`
            query getSagemakerStudioUserProfile ($sagemakerStudioUserProfileUri:String!){
                getSagemakerStudioUserProfile (sagemakerStudioUserProfileUri:$sagemakerStudioUserProfileUri){
