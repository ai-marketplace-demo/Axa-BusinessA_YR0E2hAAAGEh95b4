...
import {
    BrowserRouter as Router, Switch, Route, useLocation, matchPath, useParams, Link
...
const HeaderDecider = (props) => {
    ...
    return (
        <If condition={!matchPath(location.pathname, { path: '/:resource/:uri/:tab?', exact: false })}>
            <Then>
                {props.header}
            </Then>
            <Else>
                ...
                <Row style={{ backgroundColor: 'transparent' }} className={'m-0'}>
                    ...
                    >
                        ...
                        <Row className={'mr-1'} style={{ zIndex: '-1' }}>
                            ...
                            <Col
                                style={{
                                    height: 'auto !important', backgroundColor: 'transparent', paddingLeft: '2rem', marginLeft: sidebar ? '0%' : '3%'
                                }}
                                className={''}
                                xs={sidebar ? 10 : 12}
                            >
