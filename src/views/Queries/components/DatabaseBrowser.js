...
import { Dropdown, Menu,Icon,Loader ,Message} from 'semantic-ui-react'
...
const DatabaseBrowserItem = ({client, environment,dataset})=>{
    ...
    return <>
        ...
        <div
            ...
            <div style={{fontSize:'small', fontWeight:'bolder'}}>{dataset.name} ({tables.count})</div>
...
const DatabaseBrowser = ({environment, client})=>{
    ...
    return <div style={{overflowY:'scroll',display:'block'}}>
