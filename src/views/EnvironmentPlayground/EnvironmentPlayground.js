...
import {
    Container, Table, Row, Card, Tabs, Tab, Badge, Col, Spinner
} from 'react-bootstrap';
import {
    Link, Route, useHistory, useLocation, useParams
...
const EnvironmentPlayground = (props) => {
    ...
    const fetchEnvironment = async () => {
        const response = await client.query(getEnvironment({ environmentUri }));
        if (!response.errors) {
