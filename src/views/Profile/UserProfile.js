...
import {
    Spinner, Row, Col, Container, Badge
...
const UserProfile = (props) => {
    ...
    const fetchUserProfile = async () => {
        ...
        if (!response.errors) {
            const data = response.data.getUserProfile;
            setProfile({
                username: data.username, tags: data.tags, bio: data.bio, created: data.created, updated: data.updated
            });
        } else {
