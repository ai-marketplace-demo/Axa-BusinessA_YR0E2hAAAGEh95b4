...
const DatashopperItem = (props) => {
    ...
    return (
        <Styled>
            <Row>
                <Col xs={12}>
                    ==>{props.dataset.projectPermission}
                </Col>
            </Row>
            <Row>
                <Col xs={8}>
                    ...
                    >
                        <p>
                            <Avatar className={'mr-1'} size={32} round name={props.dataset.label} /> <b className={'text-capitalize'}>{props.dataset.label}</b>
                        </p>
                    </Link>
                </Col>
                <Col xs={4}>
            ...
            <Row>
                <Col xs={8}>
                    {props.dataset.tags.filter((t, index) => index <= 2).map((t) => <Tag tag={t} />)}
                </Col>
                <Col xs={2}>
                    {
                        (props.linkDataset) ? (
