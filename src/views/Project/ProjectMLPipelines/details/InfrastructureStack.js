    ...
    return <Container>
        {(!project || !pipeline ?(
            ...
            <div>
                <Row className={`mt-4`}>
                    <Col xs={9}>
                    <h5>CloudFormation Stack Details</h5>
                </Col>
                <Col xs={3}>
                    <b>Status : {pipeline.cfnStackStatus}</b>
                </Col>
            </Row>
            <DetailStyled>
            <Row>
            ...
            <Row>
                <Col xs={3}><b>Stack Name</b></Col>
                <Col xs={8}>
                    <code>{pipeline.cfnStackName}</code>
                </Col>
                    <Col xs={1}>
                        <Zoom color={"black"}>
                            <CopyToClipboard text={pipeline.cfnStackName}>
                                <Icon.Clipboard onClick={()=>{copy('CloudFormation Name')}} className={`ml-2`}/>
                            </CopyToClipboard>
                        </Zoom>
                    </Col>
            </Row>
            <Row>
                <Col xs={3}><b>Stack ARN</b></Col>
                <Col xs={8}>
                    <code>{pipeline.cfnStackArn}</code>
                </Col>
                <Col xs={1}>
                    <Zoom color={"black"}>
                        <CopyToClipboard text={pipeline.cfnStackArn}>
                            <Icon.Clipboard onClick={()=>{copy('CloudFormation Arn')}} className={`ml-2`}/>
                        </CopyToClipboard>
                    </Zoom>
                </Col>
            </Row>
