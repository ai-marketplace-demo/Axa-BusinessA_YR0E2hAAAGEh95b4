...
const NewProjectForm= (_props)=>{
    ...
    const submitForm=async ()=>{
        ...
        if (!res.errors){
            toast(`Created Project  ${formData.label} in ${formData.org.label}/${formData.env.label}`,{
    ...
    return <Container>
        <Row>
            <Col xs={4}>
                <h4> <Icon.FileCode xs={48}/> Create your Project</h4>
            </Col>
            <Col xs={8}>
                {(isSubmitting)?(
                    <Row>
                        ...
                        <Col xs={8}>
                            <p>Creating your project, it should take a few seconds</p>
                        </Col>
                    </Row>
                ):(
                    <div/>)}
            ...
            (!isSubmitting)?(
                ...
                <Background >
                    ...
                    <Row className={"mt-1"}>
                        ...
                        <Col xs={10}>
                            <input
                                className={`form-control`} name={"SamlGroupName"}  value={formData.SamlGroupName} onChange={handleChange} style={{width:'100%'}} placeholder={"Project Members Group"}></input>
                        </Col>
                    </Row>
                    <Row className={"mt-1"}>
