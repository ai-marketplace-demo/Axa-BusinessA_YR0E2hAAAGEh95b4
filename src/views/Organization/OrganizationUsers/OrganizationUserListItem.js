...
const OrganizationUserListItem= (props)=>{
    ...
    let canEdit = ['Owner','Admin'].indexOf(organization.userRoleInOrganization)!=-1;
    let [role,setRole] = useState({value:user.userRoleInOrganization,label:user.userRoleInOrganization});
