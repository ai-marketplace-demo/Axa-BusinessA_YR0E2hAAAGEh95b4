...
const __OrganizationListItem = (props) => {
    ...
    const canEdit = ['Owner', 'Admin'].indexOf(org.userRoleInOrganization) != -1;
        ...
        <Col className="" xs={4}>
            <OrganizationStyled color={`${canGo ? 'white' : 'ghostwhite'}`}>
                ...
                <OrganizationTitle>
                    <Row className={'mt-2'}>
                        <Col xs={2}>
                            <Avatar className={'mr-3'} size={28} round name={org.label} />
                        </Col>
                        <Col xs={7}>
