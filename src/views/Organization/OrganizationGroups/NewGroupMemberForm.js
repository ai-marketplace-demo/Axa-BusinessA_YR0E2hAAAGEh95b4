...
const NewGroupMemberForm = (props) => {
    ...
    const [notMembers, setNotMembers] = useState({ count: 0, notMembers: [] });
    ...
    const addNewMember = async ({ userName, role }) => {
        ...
        const refreshed = await client.query(listGroupNotMembers({ groupUri: group.groupUri }));
