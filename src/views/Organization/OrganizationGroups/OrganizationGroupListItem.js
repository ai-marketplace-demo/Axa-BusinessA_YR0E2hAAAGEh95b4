...
import relativeTime from 'dayjs/plugin/relativeTime'; import useClient from '../../../api/client';
...
const OrganizationGroupListItem = (props) => {
    ...
    const [role, setRole] = useState({ value: group.groupRoleInOrganization, label: group.groupRoleInOrganization });
    ...
    const handleRoleChange = async (selectOption) => {
        await props.updateRole({ group, selectRole: selectOption });
