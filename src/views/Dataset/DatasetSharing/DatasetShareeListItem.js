...
const DatasetShareeListItem= (props)=>{
    const options=[
    ...
    let [role, setRole] = useState({value:permission.userRoleForDataset,label:permission.userRoleForDataset=='TotalShare'?("Can Read All"):("Can Discover All")});
...
export default DatasetShareeListItem;
