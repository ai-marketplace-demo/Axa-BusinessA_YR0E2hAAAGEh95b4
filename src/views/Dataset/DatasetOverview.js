...
const DatasetOverView= (props)=>{
    ...
    return <Container>
        <Row>
            <Col xs={12}>
                <h4><Icon.InfoSquare/> Overview of <b className={`text-primary`}>{props.dataset.label}</b></h4>
            </Col>
        </Row>
        <OverviewStyled>
            <Row>
                ...
                <Then>
                    <If condition={hasChanged}>
                        ...
                        <Else>
                            <Row className={`mt-3`}>
                                <Col xs={3}>
                                    <button disabled className={`btn btn-sm btn-secondary disabled`}>Save</button>
                                </Col>
                            </Row>
                        </Else>
                    </If>
