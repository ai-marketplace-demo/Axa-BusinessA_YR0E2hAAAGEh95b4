...
import {
    Container, Row, Spinner, Col, Badge
                        ...
                        <If condition={displayTableList}>
                            <Then>
                                <Col
                                    xs={3}
                                    style={{
                                        minHeight: '100vh', height: 'auto !important', backgroundColor: '', zIndex: '555', borderRight: '1px solid lightgrey'
                                    }}
                                >
                                    <Row>
                                        <Col xs={4}>
                            ...
                            <Else>
                                <Col
                                    xs={1}
                                    style={{
                                        width: '22%', minHeight: '100vh', height: 'auto !important', backgroundColor: '', zIndex: '555', borderRight: '1px solid lightgrey'
                                    }}
                                >
