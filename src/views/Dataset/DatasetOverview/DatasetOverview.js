...
const DatasetOverview = (props) => {
        ...
        const response = await client.mutate(
            updateDataset({
                ...
                input: {
                    ...
                    businessOwnerDelegationEmails: details.businessOwnerDelegationEmails ? details.businessOwnerDelegationEmails.map((s) => s.value) : [],
    ...
    return (
        <Container fluid>
            ...
            <FormSection open section={'general'} content={general} />
