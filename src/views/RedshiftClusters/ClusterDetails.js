...
import {
    Container, Spinner, Row, Col, Badge, Card, DropdownButton, Dropdown, Table
                        ...
                        <tbody>
                            <tr className="d-flex">
                                ...
                                <td className="col-9">
                                    <Badge
                                        className={'mt-2'}
                                        variant={`${this.props.primary} text-uppercase`}
                                        pill
                            ...
                            <tr className="d-flex">
                                ...
                                <td className="col-9">
                                    <Badge
                                        variant={`${this.props.primary} text-uppercase`}
                                        pill
                                    >{this.props.cluster.CFNStackStatus || '-'}
                                    </Badge>
                                </td>
                            </tr>
                            <tr className="d-flex">
    ...
    return (
        <DetailStyled> <Container>
            {(!cluster ? (
                ...
                <div>
                    <FormSection section={'General Information'} content={generalInfo} open />
                    <FormSection section={'Connection'} content={connection} open />
